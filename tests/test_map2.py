...
class TestMap2:
    ...
    def test_astar(self):
        ...
        test_cases = [
            {"origin": 1, "destinations": [11], "expected_path": [], "expected_cost": 0, "expected_nodes": 0},
            {"origin": 3, "destinations": [11], "expected_path": [], "expected_cost": 0, "expected_nodes": 0},
            {"origin": 6, "destinations": [9], "expected_path": [], "expected_cost": 0, "expected_nodes": 0},
            {"origin": 5, "destinations": [11], "expected_path": [], "expected_cost": 0, "expected_nodes": 0},
            {"origin": 2, "destinations": [9, 11], "expected_path": [], "expected_cost": 0, "expected_nodes": 0},
        ]
